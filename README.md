...
export INFLUXDB_URL="YOURINFLUXSERVERIP" 
export INFLUXDB_PORT="8086" 
export INFLUXDB_DB="influx" 
export INFLUXDB_USER="admin" 
export INFLUXDB_PASSWD="admin123" 

# Endpoint URL for login action
export CLOUDFLARE_API_KEY="YOURAPIKEY"
export CLOUDFLARE_ZONE="YOURZONEID"
